; I did not create this script, it is required for Assembly_shell.asm, sharing in my repo
; because of that. This was created by Stephen Fewer and I thank him for sharing this publically
; allowing access to it as needed
